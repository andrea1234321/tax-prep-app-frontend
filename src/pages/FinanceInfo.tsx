                    ...
                    <Grid row>
                        <Grid col={6}>
                            <InputGroup>
                                ...
                                <TextInput id="other-income" name="other-income" type="number" disabled={otherIncome}/>
                            </InputGroup>
                        </Grid>
                        <Grid col={4} offset={2}>
                            <Checkbox id="na other-income" name="other-income" label="N/a" checked={otherIncome} onChange={() => setOtherIncome(!otherIncome)}/>
                        </Grid>
                    </Grid>
                    <Label htmlFor="w2-tax-withheld" requiredMarker>W2 Form(s) total income tax withheld</Label>
                    <InputGroup>
                        <InputPrefix>$</InputPrefix>
                        <TextInput id="w2-tax-withheld" name="w2-tax-withheld" type="number" required/>
                    </InputGroup>
                    <Label htmlFor="tax-withheld-1099" >1099 Form(s) total income tax withheld</Label>
                    <Grid row>
                        <Grid col={6}>
                            <InputGroup>
                                <InputPrefix>$</InputPrefix>
                                <TextInput id="tax-withheld-1099" name="tax-withheld-1099" type="number" disabled={businessWithheld}/>
                            </InputGroup>
                        </Grid>
                        <Grid col={4} offset={2}>
                            <Checkbox id="na tax-withheld-1099" name="tax-withheld-1099" label="N/a" checked={businessWithheld} onChange={() => setBusinessWithheld(!businessWithheld)}/>
                        </Grid>
                    </Grid>
                    <Label htmlFor="other-tax-withheld" >Other tax withheld</Label>
                    <Grid row>
                        <Grid col={6}>
                            <InputGroup>
                                <InputPrefix>$</InputPrefix>
                                <TextInput id="other-tax-withheld" name="other-tax-withheld" type="number" disabled={otherWithheld}/>
                            </InputGroup>
                        </Grid>
                        <Grid col={4} offset={2}>
                            <Checkbox id="na other-tax-withheld" name="other-tax-withheld" label="N/a" checked={otherWithheld} onChange={() => setOtherWithheld(!otherWithheld)}/>
                        </Grid>
                    </Grid>
                    <Label htmlFor="paid-taxes-withheld" >Paid taxes from 2022</Label>
                    <Grid row>
                        <Grid col={6}>
                            <InputGroup>
                                <InputPrefix>$</InputPrefix>
                                <TextInput id="paid-taxes-withheld" name="paid-taxes-withheld" type="number" disabled={paidWithheld}/>
                            </InputGroup>
                        </Grid>
                        <Grid col={4} offset={2}>
                            <Checkbox id="na paid-taxes-withheld" name="paid-taxes-withheld" label="N/a" checked={paidWithheld} onChange={() => setPaidWithheld(!paidWithheld)}/>
                        </Grid>
                    </Grid>
